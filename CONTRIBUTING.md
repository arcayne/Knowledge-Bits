...
Maintainers should acknowledge actionable reports, keep review decisions explicit, explain requested changes, and avoid accepting material with unclear rights. Maintainers must keep security reports private during triage and must resolve maintainer ownership and release authority before a public release or license grant.
