...
function heroPrompt(content) {
  ...
  return [
    ...
    "Match the supplied Nuglet style reference: warm cream paper, pale watercolor or gouache washes, muted clay orange, moss olive, dusty blue, delicate linework, soft painted edges, quiet editorial illustration, tactile and human.",
