# Joan first use case: AI coding workflow video

## Input

```text
https://www.youtube.com/watch?v=-QFHIoCo-Ko&t=9s
```

Canonical video ID: `-QFHIoCo-Ko`
...
9. Produce a manual X and LinkedIn handoff.

## First-use-case purpose

Use this video to test whether the pipeline can extract a useful briefing from a long AI coding
...
- Do not publish to X or LinkedIn.
- Do not treat search-result metadata as accepted research evidence.
- Do not create a fake NotebookLM notebook ID.
